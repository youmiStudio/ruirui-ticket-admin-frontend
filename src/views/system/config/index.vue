<template>
  <div class="app-container">
    <el-card class="mb-10px" shadow="never">
          ...
          <el-col :span="8">
            <el-form-item label="系统内置" prop="configType">
              ...
              >
                ...
                <el-option
                  v-for="dict in dicts.type.sys_yes_no"
                  :label="dict.label"
                  :value="dict.value"
                  :key="dict.value"
                ></el-option>
      ...
      >
        <el-table-column label="参数主键" prop="configId" align="center">
        </el-table-column>
        <el-table-column
          label="参数名称"
          prop="configName"
...
const pageConfig = reactive({
  ...
  api: {
    ...
    edit: editConfig,
    export: exportConfig,
    refreshCache: refreshCacheConfig
  },
  authorites: {
    list: 'system:config:list',
    get: 'system:config:query',
...
const dicts = useDictTypes(['sys_yes_no', 'sys_common_status']);
